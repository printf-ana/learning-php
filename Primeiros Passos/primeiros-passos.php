...
if ($idade == 18 || $idade > 18) {
    ...
    echo "Você tem ", $idade, "anos, está acompanhada, então pode entrar!" . PHP_EOL;
} else {
    echo "Esse programa só é acessível para maiores de 18 anos, ou a partir de 16 anos acompanhado.";
}
